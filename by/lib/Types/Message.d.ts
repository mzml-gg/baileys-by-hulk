...
type Contextable = {
    ...
    /** shortcut to add externalAdReply inside contextInfo — works in WhatsApp Messenger and Business */
    externalAdReply?: proto.ContextInfo.IExternalAdReplyInfo & {
        /** image buffer for the thumbnail (required for card to render) */
        thumbnail?: Buffer | Uint8Array | string | null;
        /** 1 = IMAGE, 2 = VIDEO, 0 = NONE — defaults to 1 if thumbnail is provided */
        mediaType?: number | null;
        /** show the "Ad" attribution badge — defaults to true */
        showAdAttribution?: boolean | null;
        /** render a large card thumbnail — defaults to false */
